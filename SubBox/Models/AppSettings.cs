...
namespace SubBox.Models
{
    public class AppSettings
    {
        ...
        {
            string[] options = new string[] {RetrievalTimeFrame.ToString(), NewChannelTimeFrame.ToString(), DeletionTimeFrame.ToString(), PlaylistPlaybackSize.ToString(), Color, NightMode.ToString(), LastRefresh.ToString("O"), FirstStart.ToString(), AutoStart.ToString(), DevMode.ToString() };
